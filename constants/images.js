...
const logo_otro = require("../assets/images/logo_otro.png");
const logo_restaurant = require("../assets/images/logo_restaurant.jpg");

const card = require("../assets/images/card.png");

const valentino = require("../assets/images/valentino.jpg");
